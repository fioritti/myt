package com.gcl.myt.security.oauth2;
...
import com.gcl.myt.util.CookieUtils;

import static com.gcl.myt.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if(response.isCommitted()) {
			logger.debug(String.format("Response has already committed. Unable to redirect to %s", targetUrl));
			return;
		}
